...
import { Trash2, Pause, Play, Calendar, DollarSign, ExternalLink, Zap } from 'lucide-react'
import { format } from 'date-fns'

export default function SubscriptionCard({ subscription, onDelete, onPause, index }) {
  const { _id, serviceName, price, renewalDate, status, blockchainTxnHash, isConnected } = subscription
